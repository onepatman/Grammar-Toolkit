/* =========================================================
   ...
   database with a store per feature:
     ...
     - prepEntries, articleEntries, modalEntries, capitalEntries,
       ...
       writingTemplatesEntries, spokenFluencyEntries:
                        eighteen grammar-rule categories, sharing the
                        ...
                        Paraphrasing, Writing Templates, and Spoken
                        Fluency & Register all live nested inside the
                        Course tab instead (see COURSE_LOCAL_CATEGORIES
                        in index.html). Local-only: unlike
...
(function (root, factory) {
  ...
  var SPOKEN_FLUENCY_STORE = "spokenFluencyEntries";
  ...
  function getConditionals(word, options) { return getEntry(CONDITIONALS_STORE, word, options); }
  function putConditionals(entry, options) { return putEntry(CONDITIONALS_STORE, entry, options); }
  function getAllConditionals(options) { return getAllEntries(CONDITIONALS_STORE, options); }
  function deleteConditionals(word, options) { return deleteEntry(CONDITIONALS_STORE, word, options); }

  function getActivePassive(word, options) { return getEntry(ACTIVE_PASSIVE_STORE, word, options); }
  ...
  function getRelativeClauses(word, options) { return getEntry(RELATIVE_CLAUSES_STORE, word, options); }
  ...
  function getNominalization(word, options) { return getEntry(NOMINALIZATION_STORE, word, options); }
  function putNominalization(entry, options) { return putEntry(NOMINALIZATION_STORE, entry, options); }
  function getAllNominalization(options) { return getAllEntries(NOMINALIZATION_STORE, options); }
  function deleteNominalization(word, options) { return deleteEntry(NOMINALIZATION_STORE, word, options); }

  function getCollocations(word, options) { return getEntry(COLLOCATIONS_STORE, word, options); }
  ...
  function getSpokenFluency(word, options) { return getEntry(SPOKEN_FLUENCY_STORE, word, options); }
  function putSpokenFluency(entry, options) { return putEntry(SPOKEN_FLUENCY_STORE, entry, options); }
  function getAllSpokenFluency(options) { return getAllEntries(SPOKEN_FLUENCY_STORE, options); }
  function deleteSpokenFluency(word, options) { return deleteEntry(SPOKEN_FLUENCY_STORE, word, options); }
  ...
  */
  ...
  return {
    ...
    putConditionals: putConditionals,
    getAllConditionals: getAllConditionals,
    deleteConditionals: deleteConditionals,
    ...
    getRelativeClauses: getRelativeClauses,
    ...
    getNominalization: getNominalization,
    putNominalization: putNominalization,
    getAllNominalization: getAllNominalization,
    deleteNominalization: deleteNominalization,
    ...
    getSpokenFluency: getSpokenFluency,
    putSpokenFluency: putSpokenFluency,
    getAllSpokenFluency: getAllSpokenFluency,
    deleteSpokenFluency: deleteSpokenFluency,
